...
graph TD
    subgraph Identification
        ID1["Records identified throughdatabase searching(n = 1,835)"]
    end

    subgraph Screening
        ID2["Records after duplicatesremoved(n = 1,324)"]
        ID3["Records screened(n = 1,324)"]
    end

    subgraph Eligibility
        ID4["Full-text articles assessedfor eligibility (n = 58)"]
    end

    subgraph Included
        ID5["Studies included in thereview(n = 21)"]
        ID6["Studies included in thereview(n = 22)"]
    end

    EX1["Excluded based on title or abstract(n = 1,266)"]
    EX2["Full-text articles excluded, withreasons (n = 37)<ul><li>Unsuitable outcomes(n = 16)</li><li>Isokinetic or isometrictraining (n = 8)</li><li>Unsuitable designs(n = 5)</li><li>No strengthassessment (n = 4)</li><li>Strength maintenancetraining program (n = 3)</li><li>Review article (n = 1)</li></ul>"]
    
    FWD["Forward citation tracking(n = 1745)"]
    ADD["Studies additionally included(n = 1)"]
...
<table>
  ...
  <tbody>
    <tr>
        ...
        <td>8</td>
        <td>Yes</td>
        <td>1RM bench press<br/>1RM leg press</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>6</td>
        <td>No</td>
        <td>1RM squat<br/>Isometric leg extension<br/>Isokinetic leg extension</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
        ...
        <td>9</td>
        <td>No</td>
        <td>1RM leg press<br/>1RM leg extension<br/>1RM leg curl<br/>1RM chest fly<br/>1RM biceps curl<br/>1RM seated dip</td>
    </tr>
    <tr>
        ...
        <td>8</td>
        <td>No</td>
        <td>1RM chest press<br/>1 RM leg press</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>10</td>
        <td>No</td>
        <td>1RM leg extension<br/>1RM elbow flexion</td>
    </tr>
    <tr>
        ...
        <td>16</td>
        <td>No</td>
        <td>1RM leg press<br/>1RM leg extensions</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
        ...
        <td> </td>
        <td> </td>
        <td>1RM hamstring<br/>curl<br/>1RM biceps curl<br/>1RM chest press<br/>1RM shoulder<br/>press</td>
    </tr>
    <tr>
        ...
        <td>10</td>
        <td>Yes</td>
        <td>Elbow flexion<br/>peak torque</td>
    </tr>
    <tr>
        <td>Gregory [40]</td>
        ...
        <td>14</td>
        <td>No</td>
        <td>1RM leg press<br/>1RM biceps curl<br/>1RM shoulder<br/>press<br/>1RM bench press</td>
    </tr>
    <tr>
        <td>Hunter [35]</td>
    ...
    <tr>
        <td>Lera Orsatti et al.<br/>[17]</td>
        <td>Middle-aged and older untrained women<br/>(n = 30)</td>
        <td>1/2/3</td>
        <td>3x8-12</td>
        <td>Yes</td>
        <td>16</td>
        <td>No</td>
        <td>1RM bench press<br/>1RM leg press<br/>1RM leg<br/>extensions<br/>1RM biceps curl</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
        ...
        <td>9</td>
        <td>No</td>
        <td>1RM triceps extensions<br/>1RM bench press</td>
    </tr>
    <tr>
        ...
        <td>12</td>
        <td>Yes</td>
        <td>1RM bench press<br/>1RM lat-pulldown<br/>1RM triceps press<br/>1RM biceps curl<br/>1RM lateral raise</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>12</td>
        <td>No</td>
        <td>1RM chest press<br/>1RM leg extensions<br/>1RM biceps curl</td>
    </tr>
    <tr>
...
<table>
  <tbody>
    <tr>
        ...
        <td>24</td>
        <td>No</td>
        <td>1RM leg extensions<br/>1RM biceps curl<br/>1RM bench press<br/>1RM shoulder press<br/>1RM seated lat-pulldown<br/>1RM biceps curl<br/>1RM back extensions<br/>1RM leg press<br/>1RM leg extensions<br/>1RM leg curl</td>
    </tr>
    <tr>
        ...
        <td>8</td>
        <td>Yes</td>
        <td>1RM chest press<br/>1RM hack squat</td>
    </tr>
  </tbody>
</table>
